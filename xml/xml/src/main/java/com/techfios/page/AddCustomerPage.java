...
public class AddCustomerPage {
    ...
    public String returnRandomData(String o){
        if (o.equalsIgnoreCase("zip")){
            ...
            int i = 0;
            try {
                Scanner s = new Scanner((new FileInputStream("src/otherFiles/newZipCodes.txt")));
            ...
            int i = 0;
            try {
                Scanner s = new Scanner((new FileInputStream("src/otherFiles/newEmailDomains.txt")));
            ...
            int i = 0;
            try {
                Scanner s = new Scanner((new FileInputStream("src/otherFiles/newCities.txt")));
